...
freq = 0 ;
mua_val = dlmread('generate_forward_input/mua_val_double.txt');
lmus = [ 3.0 , 3.0 , 3.0 ] ; % [inclusion, intralipid, glass]
grd = [64 64];
...
if index == 1 
    ...
    load('generate_output/network_outputs_double.mat')
end
...
for i = index : ( index + step )
    ...
    clear mesh
	n = 30000 + i ;
    mesh = toastMesh(['meshing/meshes/fmesh_' num2str(n) '.msh'],'gmsh');
...
%     colorbar
    ...
    imwrite(bbmua_image_save,['meshing/images/fmesh_' num2str(n) '_image.jpg'])
...
%% save to file
save('generate_output/network_outputs_double.mat', ...
